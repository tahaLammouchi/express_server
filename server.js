...
// built-in middleware to handle url encoded from data
...
// third-party middleware to handle cookies
...
app.use('/users', verifyJWT, verifyRoles(ROLES_LIST.Admin), require('./routes/api/users'));
...
app.use('/refresh', express.static(path.join(__dirname, 'public')));
